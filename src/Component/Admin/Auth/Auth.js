        ...
        <Paper className={isSignup ? classes.paper : classes.paper1} elevation={3}>
          ...
          <form className={classes.formData} id='authForm' onSubmit={handleSubmit}>
            <Grid container spacing={2}>
              {isSignup && (
                <>
                  <StyleTextField variant='outlined' name="firstName" label="First Name" onChange={handleChange} half className={classesTextField.TextField} />
                  <StyleTextField variant='outlined' name="lastName" label="Last Name" onChange={handleChange} half className={classesTextField.TextField} />
                </>
              )}
              ...
              {isSignup && <StyleTextField variant='outlined' name="address" label="Address" onChange={handleChange} half className={classesTextField.TextField} />}
              {isSignup && <StyleTextField variant='outlined' name="number" label="Phone Number" onChange={handleChange} half className={classesTextField.TextField} />}
            </Grid>
            ...
            <Grid container justifyContent="flex-end" style={{
              ...
              <Grid item>
                ...
                } : { color: 'rgb(89, 87, 117)', margin: '10px 1px', display: 'inline-block' }}>
