...
import { List, ListItem, ListItemButton, ListItemText, ListItemIcon, Divider, Paper, Button, Avatar } from '@mui/material'
...
const Drawered = () => {
    ...
    return (
        <div style={{
            ...
            >
                <List>
                    {['DashBoard', 'Home', 'food', 'Room'].map((text, index) => (
                        <ListItem key={text}>
                ...
                <Paper style={{
                    ...
                    <Avatar alt="Remy Sharp" src={user?.result?.selectedFile} style={{
                        display: 'block',
                        margin: '10px auto'
                    }} />
                    ...
                    }} onClick={() => navigate('/profile')} >{user?.message}</Button>
                </Paper>
                <Divider style={{ backgroundColor: 'white' }} />
            </Paper>
        </div>
